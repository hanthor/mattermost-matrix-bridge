module github.com/hanthor/mattermost-matrix-bridge
...
require (
	...
	github.com/mattermost/mattermost/server/v8 v8.0.0-20260203163203-0263262ef41b // indirect
...
replace maunium.net/go/mautrix => maunium.net/go/mautrix v0.20.0
